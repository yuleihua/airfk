...
var (
	SayHelloInMeter   = metrics.NewRegisteredMeter("{{ .Name }}/SayHello/in", nil)
	SayHelloOutMeter  = metrics.NewRegisteredMeter("{{ .Name }}/SayHello/out", nil)
	SayHelloErrorMeter  = metrics.NewRegisteredMeter("{{ .Name }}/SayHello/error", nil)
	SayHelloTimeMeter = metrics.NewRegisteredTimer("{{ .Name }}/SayHello/time", nil)
)
